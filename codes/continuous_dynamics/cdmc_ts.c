...
gcc cdmc_ts.c gen_beta.h gen_beta.c -lm
./a.out
 # Plot with gnuplot
gnuplot
...
// Global variables
    // Switches
        ...
        int s2= 2;                  // Specify the type of distribution in environmental conditions  (1: normal dist, 2: beta dist)
...
{
    // Temporal variables
        int T=          250; 	        // Duration of simulation
        double deltat=  0.005; 	        // Duration of single time step
